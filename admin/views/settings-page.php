                ...
                <section class="azevent-panel" data-panel="brand">
                    <div class="azevent-card">
                        ...
                        <div class="azevent-field">
                            ...
                            <input id="azevent_seo_brand_name" type="text" name="azevent_seo_brand_name" value="<?php echo esc_attr(get_option('azevent_seo_brand_name')); ?>">
                        </div>
                        <div class="azevent-field">
                            <label for="azevent_seo_brand_info"><?php _e('Thông tin thương hiệu', 'azevent-seo-content'); ?></label>
                            <textarea id="azevent_seo_brand_info" name="azevent_seo_brand_info" rows="4"><?php echo esc_textarea(get_option('azevent_seo_brand_info')); ?></textarea>
                        ...
                        <div class="azevent-field">
                            ...
                            <textarea id="azevent_seo_brand_solution" name="azevent_seo_brand_solution" rows="4"><?php echo esc_textarea(get_option('azevent_seo_brand_solution')); ?></textarea>
