...
<div class="wrap azevent-queue-page">
    <style>
        ...
        .azq-hero-actions { display: flex; flex: 1 1 620px; flex-wrap: wrap; justify-content: flex-end; gap: 8px; min-width: 0; max-width: 760px; }
        .azq-hero .button { display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-width: 0; min-height: 39px; padding-right: 14px; padding-left: 14px; border-color: rgba(255,255,255,.35); border-radius: 9px; background: rgba(255,255,255,.12); color: #fff; font-weight: 700; white-space: nowrap; }
        ...
        @container azq (max-width: 820px) { .azq-stats { grid-template-columns: repeat(2,minmax(0,1fr)); } }
        @container azq (max-width: 520px) { .azq-hero-actions, .azq-stats { grid-template-columns: minmax(0,1fr); } .azq-hero-actions .button, .azq-hero-actions .button:nth-last-child(2):nth-child(3n + 1) { grid-column: auto; } .azq-toolbar { grid-template-columns: minmax(0,1fr); } .azq-toolbar-status { justify-content: space-between; } }
        @supports not (container-type: inline-size) {
            ...
            @media (max-width: 1000px) { .azq-stats { grid-template-columns: repeat(2,minmax(0,1fr)); } }
            @media (max-width: 700px) { .azq-hero-actions, .azq-stats { grid-template-columns: minmax(0,1fr); } .azq-hero-actions .button, .azq-hero-actions .button:nth-last-child(2):nth-child(3n + 1) { grid-column: auto; } .azq-toolbar { grid-template-columns: minmax(0,1fr); } .azq-toolbar-status { justify-content: space-between; } }
        }
