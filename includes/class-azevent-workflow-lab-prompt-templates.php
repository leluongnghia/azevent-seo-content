...
5. Xác định content gap và information gain có thể tạo từ dữ liệu thương hiệu: quy trình thực tế, checklist, tiêu chí lựa chọn, yếu tố chi phí, timeline, vai trò, rủi ro và cách xử lý.
6. Lập Evidence Map: thông tin nào được phép khẳng định từ hồ sơ thương hiệu; thông tin nào phải tránh hoặc cần người dùng bổ sung bằng chứng.
7. Nếu có dữ liệu đối thủ thật, chỉ phân tích nội dung được cung cấp và nêu cơ hội khác biệt; không suy đoán thứ hạng ngoài dữ liệu.
8. Đề xuất góc tiếp cận people-first và lời hứa nội dung thực tế, không clickbait.
